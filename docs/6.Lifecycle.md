...
![初始化和销毁](https://cdn.jsdelivr.net/gh/Vincent-Vic/spring-mini@master/docs/image/image/lifecycle.png)

## 6.1 类图
![类图](https://cdn.jsdelivr.net/gh/Vincent-Vic/spring-mini@master/docs/image/image/lifecycle-uml.png)
## 6.2 初始化
